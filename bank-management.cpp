...
void Bank::transferMoney()
{
    ...
    cout << "\nTransfer Proccessisfailed due to incorrect infomation please try again\n\n";
}
void Bank::showStatement()
{
    ...
    if (!isFound)
    {
        cout << "\nBalance check Proccess isfailed due to incorrect infomation Please try again\n\n";
    }
}
int main()
{
